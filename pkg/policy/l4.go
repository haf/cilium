...
// regeneration on existing users so they migrate.
// The endpointID argument ensures that supersede does not trigger a
// regeneration on the endpoint that initiated the selector policy update.
