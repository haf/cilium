...
// Supersede detaches the policy between the statedb read and AddHold. The
// regen loop must fall through to wait for the replacement entry.
func TestSupersedeDuringRegen(t *testing.T) {
	f := newPolicyTestFixture(t)
	logger := hivetest.Logger(t)
